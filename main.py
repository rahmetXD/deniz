...
bot_token = os.environ.get("TOKEN","6645400469:AAEHTsNLDuwbd9AAmScXJrq3NzWna-9aE-c") # Botunuzun Tokenini Girin.
sahib = os.environ.get("sahib", "5944841427") # Sahiplik Hesabin Kullanıcı Adını Girin .
BOT_ID = int(os.environ.get("BOT_ID", "6645400469")) # Botunuzun İd'si ( Tokenin Başındaki Rakamları ) Girin .
DATABASE_URL = os.environ.get("DATABASE_URL","") # MongoDB veritabanınızın url'si.
BOT_USERNAME = os.environ.get("BOT_USERNAME","Ahriv2_bot") # Botunuzun kullanıcı adı.
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL","-1001910817002")) # Botunuzun eylemleri kaydedeceği kayıt grubunun id'si.
GROUP_SUPPORT = os.environ.get("GROUP_SUPPORT", "redhackchet") # Botunuzdan yasaklanan kullanıcıların itiraz işlemleri için başvuracağı grup, kanal veya kullanıcı. Boş bırakırsanız otomatik olarak OWNER_ID kimliğine yönlendirecektir.
